...
var de_einwohner_gesamt : number = 83140000;
    ...
    console.log(de_einwohner_gesamt/eu_einwohner_gesamt*100 +" %");
...
var fr_einwohner_gesamt : number =65120000;
    ...
    console.log(fr_einwohner_gesamt/eu_einwohner_gesamt*100 +" %");
...
var sp_einwohner_gesamt : number = 47110000;
    ...
    console.log(sp_einwohner_gesamt/eu_einwohner_gesamt*100 +" %");
