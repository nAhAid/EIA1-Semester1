...
let queryParamsFailed: URLSearchParams = new URLSearchParams(window.location.search);
//In Zeile vier werden die abgerufenen Parameter in der Variable "lang" abgespeichert
let langFailed: string = queryParamsFailed.get("lang");
let diffFailed: number = parseInt(queryParamsFailed.get("diff"));
